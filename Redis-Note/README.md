...
> ![image-20240919165039748](./assets/image-20240919165039748.png)
...
在多线程的情况下如果有类似秒杀场景，则可能产生超卖，对应的解决方案有悲观锁和乐观锁：

1. 悲观锁：即添加同步锁，让线程串行执行；其优点在于实现简单，缺点在于性能较低。
2. 乐观锁：即不加锁，仅在更新时判断是否有其他线程在修改，实现方法有版本号；其优点在于性能好，缺点则是可能产生成功率低的问题。
